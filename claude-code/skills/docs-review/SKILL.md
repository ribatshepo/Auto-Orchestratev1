...
name: docs-review
description: |
  Documentation review skill for checking style guide compliance.
  Use when the user asks to "review documentation", "check docs style",
  "review this markdown file", "check style guide compliance", "review PR documentation",
  or needs documentation reviewed against the writing style guide.
  Supports both local file review and GitHub PR review modes with inline comments.
triggers:
...
| Pattern                       | Issue                                         |
| ----------------------------- | --------------------------------------------- |
| we can do X, our feature      | Should be product name or "it"                |
